...
<?php
  $head =[ 
    "titulo"=> "BI Inteegraciones",
    "descripcion"=> "BI Inteegraciones",
...
<body>
    ...
    ?>
        ...
        <?php 
      include "_inc_bi_cab.php";
    ?>
      

        <?php 
      include "_inc_bi_beneficios.php"; 
    ?>
    <?php 
      include "_inc_bi_recursos.php"; 
    ?>
<?php
include "_inc_bi_integraciones.php";
?>
        <!-- /section -->
